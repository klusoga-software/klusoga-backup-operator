...
// MssqlTargetSpec defines the desired state of MssqlTarget
...
type MssqlTarget struct {
	...
	Spec   MssqlTargetSpec   `json:"spec,omitempty"`
	Status MssqlTargetStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// MssqlTargetList contains a list of MssqlTarget
type MssqlTargetList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []MssqlTarget `json:"items"`
}

func init() {
	SchemeBuilder.Register(&MssqlTarget{}, &MssqlTargetList{})
}
